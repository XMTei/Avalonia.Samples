...
{
    public class PaintControlViewModel: ViewModelBase
    {
        ...
        public bool Dragging
        {
            ...
            set
            {
                ...
                {
                    _dragging = value;
                    this.RaisePropertyChanged(nameof(Dragging));
        ...
        public Point Pos
        {
            ...
            set
            {
                ...
                {
                    _pos = value;
                    this.RaisePropertyChanged(nameof(Pos));
        ...
        public Rect Marquee
        {
            ...
            set
            {
                ...
                {
                    _marquee = value;
                    this.RaisePropertyChanged(nameof(Marquee));
